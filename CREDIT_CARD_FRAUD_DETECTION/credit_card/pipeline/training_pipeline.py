...
class TrainPipeline:
    ...
    # 🟢 FIX: Correctly aligned inside the indentation block of TrainPipeline class
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            logging.info("Initiating Data Ingestion runtime segment.")
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        try:
            logging.info("Initiating Data Validation drift analysis sequence.")
    ...
    def start_data_transformation(self, data_ingestion_artifact: DataIngestionArtifact, 
        ...
        try:
            logging.info("Initiating Scaling and Resampling Transformation operations arrays cascade.")
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact) -> ModelTrainerArtifact:
        try:
            logging.info("Initiating dynamic GridSearch Hyperparameter optimization training layer.")
    ...
    def run_pipeline(self) -> None:
        try:
            ...
            # Linearly binding Model Trainer stage execution output states down the line
            model_trainer_artifact = self.start_model_trainer(data_transformation_artifact=data_transformation_artifact)
            logging.info("MLOps Industrial Execution Pipeline chain completed successfully up to Model Training phase.")
        except Exception as e:
            raise CreditCardException(e, sys) from e