# eske bad pipeline/trainig_pipeline file me code add krna hai 
import sys
...
from us_visa.entity.estimator import USvisaModel # Eske bad entity/estimator.py file me jake code likha hai 
